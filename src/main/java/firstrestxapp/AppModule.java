...
public class AppModule {
    ...
    public SignatureKey signatureKey() {
         return new SignatureKey("firstrestxapp 6fe472e1-b0f0-4695-b7d2-00002e231c7d FirstRestxApp -5670216599588338522".getBytes(Charsets.UTF_8));
    }
    ...
    public ConfigSupplier appConfigSupplier(ConfigLoader configLoader) {
        // Load settings.properties in firstrestxapp package as a set of config entries
        return configLoader.fromResource("firstrestxapp/settings");
    }
